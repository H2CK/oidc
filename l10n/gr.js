OC.L10N.register(
    ...
    "Secret" : "Μυστικό",
    "Show client secret" : "Εμφάνιση του μυστικού του πελάτη",
    ...
    "Add" : "Προσθέστε",
    "Settings" : "Ρυθμίσεις",
    "Token Expire Time" : "Χρόνος λήξης κουπονιού",
    "Public Key" : "Δημόσιο κλειδί",
    "Regenerate Keys" : "Αναγέννηση κλειδιών",
    "OpenID Connect Redirect" : "Ανακατεύθυνση OpenID Connect",
    "Your client is not authorized to connect. Please inform the administrator of your client." : "Ο πελάτης σας δεν είναι εξουσιοδοτημένος να συνδεθεί. Παρακαλούμε ενημερώστε τον διαχειριστή του πελάτη σας.",
