OC.L10N.register(
    ...
    "Select to enable/disable the Dynamic Client Registration" : "Seleccione para ativar/desativar o registo dinâmico de clientes",
    "Disable" : "Desativar",
    "Enable" : "Activar",
    ...
    "Integrate avatar in user info/ID token" : "Integrar o avatar ao identificação do usuário/ID token",
    "Method for integration of avatar" : "Método de integração do avatar",
    "Select how the avatar image should be integrated" : "Selecionar a forma como a imagem do avatar deve ser integrada",
    "No integration" : "Sem integração",
    "Add to user info" : "Adicionar à informação do utilizador",
    "Add to user info and ID token" : "Adicionar à informação do utilizador e ao ID token",
    "Accepted Logout Redirect URIs" : "Aceite Logout Redireccionar URIs",
