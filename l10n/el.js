OC.L10N.register(
    ...
    "OpenID Connect allows to authenticate at external services with your user account." : "Το OpenID Connect επιτρέπει τον έλεγχο ταυτότητας σε εξωτερικές υπηρεσίες με το λογαριασμό χρήστη σας.",
