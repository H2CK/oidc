OC.L10N.register(
    ...
    "User can not edit any settings" : "Ο χρήστης δεν μπορεί να επεξεργαστεί καμία ρύθμιση",
    ...
    "All settings for the login at other services using the OpenID Connect Provider app are managed by your administrator." : "Όλες οι ρυθμίσεις για τη σύνδεση σε άλλες υπηρεσίες που χρησιμοποιούν την εφαρμογή OpenID Connect Provider διαχειρίζεται ο διαχειριστής σας."
},
