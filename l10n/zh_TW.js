OC.L10N.register(
    ...
    "User is administrator" : "使用者是管理員",
    "User is group administrator" : "使用者是群組管理員",
    "User has a specific role" : "使用者有特定角色",
    "User is in a specific group" : "使用者在特定群組中",
    "Return user's primary email address" : "回傳使用者的主要電子郵件地址",
    "Return user's groups as array of group IDs" : "回傳使用者的群組（以群組 ID 的陣列形式）",
    "Return user's groups as array of display names" : "回傳使用者的群組（以顯示名稱的陣列形式）",
    "Return user's groups as comma-separated string" : "以逗號分隔字串形式回傳使用者的群組",
    "Return user's groups as comma-separated display names" : "以逗號分隔顯示名稱形式回傳使用者的群組",
    "Return user's language setting" : "回傳使用者的語言設定",
    "Return user's locale setting" : "回傳使用者的地區設定",
    "Return user's first day of week setting" : "回傳使用者的一週的第一天設定",
    "Return user's timezone setting" : "回傳使用者的時區設定",
    "Confidential" : "機密",
    "Public" : "公開",
    "Avatar" : "頭像",
    "Address" : "地址",
