OC.L10N.register(
    ...
    "Integrate avatar in user info/ID token" : "在使用者資訊/ID 權杖中整合大頭貼",
    "Method for integration of avatar" : "大頭貼的整合方法",
    "Select how the avatar image should be integrated" : "選取大頭貼影像要如何整合",
    "No integration" : "無整合",
    "Add to user info" : "新增至使用者資訊",
    "Add to user info and ID token" : "新增至使用者資訊與 ID 權杖",
