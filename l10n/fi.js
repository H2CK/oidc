OC.L10N.register(
    ...
    "Integrate avatar in user info/ID token" : "Avatarin sisällyttäminen käyttäjän tietoihin/tunnisteeseen",
    "Method for integration of avatar" : "Menetelmä avatarin integroimiseksi",
    "Select how the avatar image should be integrated" : "Valitse, miten avatar-kuva integroidaan",
    "No integration" : "Ei integrointia",
    "Add to user info" : "Lisää käyttäjätietoihin",
    "Add to user info and ID token" : "Lisää käyttäjätietoihin ja ID-tunnisteeseen",
