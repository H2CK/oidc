OC.L10N.register(
    ...
    "Allowed Scopes" : "Zulässige Berechtigungsumfänge",
    "Save allowed scopes" : "Zulässige Berechtigungsumfänge speichern",
    "Save" : "Speichern",
    "Define the allowed scopes for the client separated by a whitespace, e.g. openid profile roles. Do not enter any value to allow all scopes." : "Definiere die zulässigen Berechtigungsumfänge für den Client, getrennt durch ein Leerzeichen, z. B. openid profile roles. Gib keinen Wert ein, um alle Berechtigungsumfänge zuzulassen.",
    "Email Selection" : "E-Mail-Auswahl",
    "Save email selection regex" : "E-Mail-Auswahl-Regex speichern",
    "Usually the primary email address is used during OpenID control flows. If you wish to use other email adresses (defined as secondary email address in personal settings) you could define a regular expression for selecting the used email address. E.g. .*@domain.tld" : "Normalerweise wird die primäre E-Mail-Adresse bei OpenID-Kontrollflüssen verwendet. Wenn du andere E-Mail-Adressen verwenden möchtest (definiert als sekundäre E-Mail-Adresse in den persönlichen Einstellungen), kannst du einen regulären Ausdruck für die Auswahl der verwendeten E-Mail-Adresse definieren. Z. B. .*@domain.tld",
    "All settings for the login at other services using the OpenID Connect Provider app are managed by your administrator." : "Alle Einstellungen für die Anmeldung bei anderen Diensten mit der OpenID Connect-Anbieter-App werden von deiner Administration verwaltet."
},
