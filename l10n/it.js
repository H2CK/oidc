OC.L10N.register(
    ...
    "Integrate Avatar in user info / id token" : "Integrare l'avatar nelle informazioni sull'utente / token id",
    "Method for integration of avatar" : "Metodo per l'integrazione di avatar",
    "Select how the avatar image should be integrated" : "Selezionare come integrare l'immagine dell'avatar",
    "No integration" : "Nessuna integrazione",
    "Add to user info" : "Aggiungere alle informazioni sull'utente",
    "Add to user info and id token" : "Aggiungere alle informazioni sull'utente e al token id",
    "Accepted Logout Redirect URIs" : "URI di reindirizzamento del logout accettati",
