OC.L10N.register(
    ...
    "The user is not member of the groups defined for the client. You are not allowed to retrieve a login token." : "O usuário não é membro dos grupos definidos para o cliente. O usuário não tem permissão para recuperar um token de login.",
