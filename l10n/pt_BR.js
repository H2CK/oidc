OC.L10N.register(
    ...
    "Return users primary email address" : "Devolver o endereço de e-mail principal do usuário",
    "Return users groups as array of group IDs" : "Devolver grupos de usuários como arranjo de IDs de grupo",
    "Return users groups as array of display names" : "Devolver grupos de usuários como arranjo de nomes de exbição",
    ...
    "Parameters are required for the selected function" : "Os parâmetros são necessários para a função selecionada",
    ...
    "Add Custom Claim" : "Adicionar declaração personalizada",
    "is_admin" : "is_admin",
    "Define the name of the custom claim." : "Definir o nome da declaração personalizada.",
    "Scope" : "Escopo",
    "profile" : "perfil",
