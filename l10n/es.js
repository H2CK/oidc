OC.L10N.register(
    ...
    "Regenerate Keys" : "Regenerar llaves",
    "OpenID Connect Redirect" : "Redirección de OpenID Connect",
    "Your client is not authorized to connect. Please inform the administrator of your client." : "Su cliente no está autorizado a conectarse. Por favor, informe al administrador de su cliente.",
    "The received redirect uri is not accepted to connect. Please inform the administrator of your client." : "La uri de redirección recibida no es aceptada para conectarse. Por favor, informe al administrador de su cliente.",
    "Your redirect URL needs to be a full URL for example: https://yourdomain.com/path" : "Su URL de redirección debe ser una URL completa, por ejemplo: https://yourdomain.com/path",
